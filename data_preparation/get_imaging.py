"""!@file get_imaging.py
@brief Download imaging data from the KiTS19 dataset.

@details This script is taken from the KiTS19 challenge repository (https://github.com/neheller/kits19) and is used to download the imaging data from the KiTS19 dataset. The script downloads the imaging data for all 300 cases in the dataset. The script is run from the command line and the imaging data is saved in the data/case_{:05d}/imaging.nii.gz directory.
"""
